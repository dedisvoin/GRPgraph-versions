...
def Get_GRPgraph_wersion():
    print(colorama.Fore.BLUE+'GRPgraph version (15.5.122с)'+colorama.Fore.RESET)
# 1
class Vec2:
...
class Text_:
    ...
    def SETTEXTBG(self,col=(0,0,0)):
        bg = Screen_.f2D.Rect(col,[self.x,self.y],[len(self.text)*12.5+len(self.text)+len(self.text),self.pix+10],0,self.screen1)
        bg.Draw()
        screen.blit(self.texttt,(self.x,self.y))      
# 6 -- new !! do not work
class Math_:
...
class Screen_:
    ...
    def SETFPS(self,fps):
        ...
        self.clock.tick(fps)
    def GETFPS(self):return int(self.clock.get_fps())
                                            ...
                                            class Line:
                                                ...
                                                def Draw(self):
                                                    ...
                                                    if self.type == 'S' or self.type == 's':
                                                        Screen_.f2D.Circle(self.col,[self.start_pos[0]+self.sh/12,self.start_pos[1]]
                                                        ,self.sh/2-0.5,0,self.surf).Draw()
                                                        Screen_.f2D.Circle(self.col,[self.end_pos[0]+self.sh/12,self.end_pos[1]]
                                                        ,self.sh/2-0.5,0,self.surf).Draw()
